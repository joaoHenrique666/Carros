...
public class MinhaThread implements Runnable {
	...
	public MinhaThread(Socket cliente) {
		this.cliente = cliente;
	}
	@Override
	public void run() {
		try {
			Scanner DadosDoCliente;
			DadosDoCliente = new Scanner(this.cliente.getInputStream());
			PrintStream saidaDadosParaCliente = new PrintStream(this.cliente.getOutputStream());
			
			while(true){
				String comando = DadosDoCliente.nextLine();
				...
				if (carros.containsKey(comando)){
					...
					saidaDadosParaCliente.println("Usuario desconectado.");
					break;
					...
					saidaDadosParaCliente.println("Opcao invalida.");
				}
